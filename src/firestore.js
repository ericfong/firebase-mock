...
MockFirestore.prototype.runTransaction = function(transFunc) {
  ...
  return new Promise(function(resolve, reject) {
    Promise.resolve(transFunc(batch))
      .then(function(value) {
        batch
          .commit()
          .then(function() {
...
MockFirestore.prototype._child = function(childPath, findingDoc) {
  ...
  if (!child) {
    ...
    if (firstChildIsDoc) {
      child = new DocumentReference(
        this.path === DEFAULT_PATH ? childKey : utils.mergePaths(this.path, childKey),
