...
function bundle() {
  ...
  return browserify({
    ...
    .pipe(buffer())
    .pipe(
      plugins.header(fs.readFileSync('./helpers/header.txt'), {
        pkg: _.assign(
  ...
  new Server(
    {
      ...
      files: ['node_modules/es5-shim/es5-shim.js', 'test/unit/!(firestore-delta-document-snapshot).js'],
      plugins: ['karma-phantomjs-launcher', 'karma-mocha', 'karma-sinon', 'karma-browserify'],
      preprocessors: {
  ...
  new Server(
    {
      ...
      files: [bundlePath, 'test/smoke/globals.js'],
