...
describe('MockFirestore', function() {
  ...
  describe('#collection', function() {
    ...
    it('caches deep children with paths', function() {
      expect(db.collection('collections/doc/collections2')).to.equal(
        db
          .collection('collections')
          .doc('doc')
          .collection('collections2')
  ...
  describe('#doc', function() {
    ...
    it('caches deep children with paths', function() {
      expect(db.doc('doc/collections/doc2')).to.equal(
        db
          .doc('doc')
          .collection('collections')
          .doc('doc2')
  ...
  describe('#batch', function() {
    it('batch runs commands after commit', function(done) {
      ...
      Promise.all([
        expect(db.doc('doc2').get())
          .to.eventually.have.property('exists')
          .equal(false),
        expect(
          db
            .collection('collections')
    ...
    it('supports method chaining', function() {
      ...
      var awaitChecks = Promise.all([doc1.get(), doc2.get(), doc3.get(), doc4.get()]).then(function(snaps) {
    ...
    context('when "batch.commit" is not called', function() {
      ...
      it('does not create documents', function(done) {
        ...
        expect(function() {
          db.flush()
        }).to.throw('No deferred tasks to be flushed')

        var promises = [db.doc('col/batch-foo').get(), db.doc('col/batch-bar').get()]
        db.flush()
  ...
  describe('#getAll', function() {
    it('gets the value of all passed documents', function() {
      ...
      var getAll = db.getAll(doc1, doc2, doc3)
