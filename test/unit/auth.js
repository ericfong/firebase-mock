...
describe('Auth', function() {
  ...
  describe('#getUserByEmail', function() {
    ...
    it('gets a copy of the user by email', function() {
      ...
      return Promise.all([expect(found).to.eventually.have.property('uid', 'bd'), expect(found).to.eventually.have.property('email', 'ben@example.com')])
    })
    ...
    it('removes the account', function() {
      ...
      return ref.getUserByEmail('kato@kato.com').then(function(user) {
        expect(user)
          ...
          .to.equal('simplelogin:1')
        expect(user)
          .to.have.property('email')
          .to.equal('kato@kato.com')
        expect(user)
      ...
      return ref
        ...
        .then(function(user) {
          return ref
            ...
            .then(function() {
              return expect(ref.getUser(user.uid))
                .to.eventually.have.property('customClaims')
